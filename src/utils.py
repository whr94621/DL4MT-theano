...
from .metric.bleu_score import corpus_bleu
...
class GlobalNames:
    ...
    MY_DEFAULT_TRNG = MRG_RandomStreams(1234)

    USE_NOISE = theano.shared(value=1.0, name="noise_switcher")
